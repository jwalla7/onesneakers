...
//        Optional<customerentity> userResponse = usecustomerrepository.findByEmail(email);
//        if(userResponse.isEmpty())
//            throw new UsernameNotFoundException("Customer not findUser with email = " + email);
//        customerentity customerentity = userResponse.get();
